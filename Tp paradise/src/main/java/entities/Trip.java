...
public class Trip {
   ...
   public Trip(Place depart, Place destination, int price) {
     this.depart = depart;
	...
	public Trip(int id,Place depart, Place destination, int price) {
        this.id = id;
		this.depart = depart;
        this.destination = destination;
	    this.price = price;
    ...
    @Override
   	public String toString() {
   		return "Trip [id=" + id + ", depart=" + depart + ", destination=" + destination + ", price=" + price + "]";
   	}
